...
(function initSkills() {
  ...
  var data = {
    ai: [
      ...
      { name: 'NLP & Transformers',        pct: 82, emoji: '\uD83D\uDCAC' },
      { name: 'LLM Concepts',             pct: 80, emoji: '\u2728' },
      { name: 'LangChain',                pct: 85, emoji: '\uD83E\uDEDC' },
      { name: 'LangGraph (AI Agents)',    pct: 80, emoji: '\uD83E\uDDE0' },
      { name: 'RAG Architectures',        pct: 84, emoji: '\uD83D\uDDC2\uFE0F' },
      { name: 'Vector Databases',          pct: 78, emoji: '\uD83D\uDCBE' },
